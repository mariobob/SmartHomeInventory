...
function onOpen() {
  ...
  ui.createMenu('🏠 Smart Home Tools')
    ...
    .addSubMenu(ui.createMenu('📷 Photo Intake')
      ...
      .addSeparator()
      .addSubMenu(ui.createMenu('Reader mode')
        .addItem('Use OCR (Drive)', 'setIntakeReaderOCR')
        .addItem('Use Claude vision (AI)', 'setIntakeReaderAI')
        .addItem('Turn off', 'setIntakeReaderOff')
        .addSeparator()
